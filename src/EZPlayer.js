...
class EZPlayer extends Component {
  static propTypes = {
    ...
    onPlayerCloseFloatPlayer: PropTypes.func,
    onPlayerExpandFloatPlayer: PropTypes.func,
  };
  ...
  */
  constructor(props) {
    ...
    this.events = {
      ...
      onPlayerCloseFloatPlayer: this._onPlayerCloseFloatPlayer.bind(
        this,
      ),
      onPlayerExpandFloatPlayer: this._onPlayerExpandFloatPlayer.bind(
        this,
      ),
    };
  ...
  */
  ...
  _onPlayerCloseFloatPlayer(event) {
    console.log(
      '[EZPlayer] onPlayerCloseFloatPlayer ' +
      JSON.stringify(event.nativeEvent),
    );
    if (
      typeof this.props.onPlayerCloseFloatPlayer === 'function'
    ) {
      this.props.onPlayerCloseFloatPlayer(...arguments);
    }
  }

  _onPlayerExpandFloatPlayer(event) {
    console.log(
      '[EZPlayer] onPlayerExpandFloatPlayer ' +
      JSON.stringify(event.nativeEvent),
    );
    if (
      typeof this.props.onPlayerExpandFloatPlayer === 'function'
    ) {
      this.props.onPlayerExpandFloatPlayer(...arguments);
    }
  }
  ...
  render() {
    return (
      <EZRNPlayerViewNative
        ...
        onPlayerCloseFloatPlayer={
          this.events.onPlayerCloseFloatPlayer
        }
        onPlayerExpandFloatPlayer={
          this.events.onPlayerExpandFloatPlayer
        }
      />
    );
  }
