...
@property (nonatomic, strong, nullable) RCTDirectEventBlock onPlayerCloseFloatPlayer;
@property (nonatomic, strong, nullable) RCTDirectEventBlock onPlayerExpandFloatPlayer;
